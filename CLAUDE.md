...
- Uses tidyverse style enforced by styler (see `.lintr` for
  configuration)
- Line length limit: 120 characters
- Some example files are excluded from linting/styling (see `.lintr` and
  `scripts/style.R`)
...
**README Generation**: README.md is auto-generated from README.Rmd and
should never be edited directly. The first line of README.md indicates
this.
