...
##' they should be used as base themes from which to build
##' a new theme.  Building a theme from \code{theme_gray} or
##' \code{theme_bw} is a pain if the theme is not simply
##' making minor tweaks to those themes because those themes
