...
- BREAKING CHANGE: `hc_pal("default")` now returns the palette
  Highcharts has used by default since v11.0.0 (`#2caffe`, `#544fc5`,
  `#00e272`, …). It previously returned the palette used before v11
  (`#7cb5ec`, `#434348`, …), which Highcharts replaced in April 2023.
  Plots using
...
- [`hc_pal()`](https://jrnold.github.io/ggthemes/reference/hc_pal.md)
  and
  [`scale_colour_hc()`](https://jrnold.github.io/ggthemes/reference/scale_hc.md)/[`scale_fill_hc()`](https://jrnold.github.io/ggthemes/reference/scale_hc.md)
...
- [`theme_hc()`](https://jrnold.github.io/ggthemes/reference/theme_hc.md)’s
  examples now pass `style` rather than the deprecated `bgcolor`, and
