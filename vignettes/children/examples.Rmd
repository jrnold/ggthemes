...
Color palette based on [Paul Tol's Colour Schemes](https://personal.sron.nl/~pault/colourschemes.pdf). The default palette consists of 9 colors and can be used as a generic option for up to 9 levels. If the number of levels is known, then use of the specific palette (e.g., `ptol4_qual` for 4 levels) is preferred.
